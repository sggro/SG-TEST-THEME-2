    ...
    <div class='sg-footer'>
        <div class="sg-footer-social-media">
            ...
            <div class="sg-footer-social-media-icon">
                <a href={$theme.sgSocialMediaInstagramLink} target='_blank'>
            ...
            {if $theme.sgSocialMediaFacebookLink}
                <div class="sg-footer-social-media-icon">
                    <a href={$theme.sgSocialMediaFacebookLink} target='_blank'>
            ...
            {if $theme.sgSocialMediaTwitterLink}
                <div class="sg-footer-social-media-icon">
                    <a href={$theme.sgSocialMediaTwitterLink} target='_blank'>
            ...
            <div class="sg-footer-social-media-icon">
                <a href={$theme.sgSocialMediaYoutubeLink} target='_blank'>
